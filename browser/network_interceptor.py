...
def _claude_api_url(url: str) -> bool:
    u = url.lower()
...
class ClaudeNetworkCollector:
    """Captures JSON/SSE bodies from claude.ai traffic for parsing; DOM remains fallback."""

    def __init__(self, page: Page, on_record: Optional[Callable[[dict[str, Any]], None]] = None) -> None:
        self._page = page
